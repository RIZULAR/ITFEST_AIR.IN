...
function shareToWhatsApp(ranked) {
	...
	lines.push("", "Generated by airin DSS");
						...
						{filtered.map((f, idx) => {
							...
							return (
								<Box key={f.id}>
									...
									>
										<Stack direction="row" alignItems="center" spacing={1.5} sx={{ width: "100%", overflow: "hidden" }}>
											<Box
											...
											<Box sx={{ flex: 1 }}>
												...
												<Typography
													variant="caption"
													sx={{ color, fontSize: 10, display: "block", lineHeight: 1 }}
												>
